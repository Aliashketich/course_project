        ...
        <div id="slidemenu">
            ...
            <%--<ul class="nav navbar-nav">--%>
                <%--<li>--%>
                    ...
                    <%--</form>--%>
                <%--</li>--%>
                <%--&lt;%&ndash;<li><a href="http://bootstraptema.ru/">Главная</a></li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li><a href="http://bootstraptema.ru/stuff/templates_bootstrap/1">Шаблоны</a></li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li><a href="http://bootstraptema.ru/stuff/plugins_bootstrap/2">Плагины</a></li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li><a href="http://bootstraptema.ru/stuff/snippets_bootstrap/3">Сниппеты</a></li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Ещё <b&ndash;%&gt;--%>
                <%--&lt;%&ndash;class="caret"></b></a>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<ul class="dropdown-menu">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li><a href="http://bootstraptema.ru/stuff/0-0-0-0-1">Заработать</a></li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li><a href="http://bootstraptema.ru/index/best_for_bootstrap/0-4">Топ 100</a></li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<li><a href="http://bootstraptema.ru/index/feedback/0-3">Связь</a></li>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</ul>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</li>&ndash;%&gt;--%>
            <%--</ul>--%>
